function [al_x,AL_X]=sa_partial(ini_x,A,change_num)%Partial support altering for sPCA
%in_x is a PC-loading vector. A is the covariance matrix
approx_inf=1e2;%a constant to approximate infty
...
if card_ini~=1
    ...
    f_ini=in_x_supp_ini'*in_x_supp_ini;
    ...
    for k=1:change_num
        ...
        D_Q_all_12=-Q_1_2;
        D_Q_all_13=Q_1_1.*Q_2_3-Q_1_3;
        D_Q_all_23=Q_1_2.*Q_2_3;
        ...
        VALUE=(Q_1_1.*ENTRY.^2+2.*Q_1_2.*ENTRY+Q_1_3)./(ENTRY.^2+Q_2_3);
        [~,in_id]=max(VALUE);
        %out_x
        i=I(in_id);
        al_x(i)=ENTRY(in_id);
